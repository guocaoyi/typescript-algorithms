...
export class BinarySearchTreeNode {
  ...
  #preOrderedTraverNode = (node: BinarySearchTreeNode, cb: (node: BinarySearchTreeNode) => void) => {
    cb(node);
  ...
  #inOrderedTraverNode = (node: BinarySearchTreeNode, cb: (node: BinarySearchTreeNode) => void) => {
  ...
  #postOrderedTraverNode = (node: BinarySearchTreeNode, cb: (node: BinarySearchTreeNode) => void) => {
